...
def update_graph(column_name,scaling):  # function arguments come from the component property of the Input
    print(column_name)
    print(type(column_name))
    dff = df
    
    dff['Cesarean Delivery Rate'] = dff['Cesarean Delivery Rate']*scaling/100
