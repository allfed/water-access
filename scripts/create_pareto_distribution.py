...
def fit_gpd(
    ...
    def objective_gpd(params):
        ...
        samples = genpareto.rvs(
            c=shape_param, loc=loc_param, scale=scale_param, size=sample_size
        )
    ...
    samples_optimized = genpareto.rvs(
        c=shape_opt, loc=loc_param, scale=scale_opt, size=sample_size
    )
