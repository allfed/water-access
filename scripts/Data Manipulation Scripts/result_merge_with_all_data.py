...
parquet_file_path = parquet_data_dir / "zone_simulation_result_5th_percentile.parquet"
original_csv_file_path = csv_data_dir / "updated_GIS_output_cleaned.csv"
output_file_path = results_dir / "5th_results_all_data.csv"  # Adjust the path as needed
...
merged_df = pd.merge(merged_df,country_data_df, left_on="ISOCODE", right_on="alpha3", how="outer")
