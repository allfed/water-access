...
df = df.merge(df_country[['alpha3', 'Population']], left_on='shapeGroup', right_on='alpha3', how='inner')

# Calculate population density percentage
df['pop_density_perc'] = df.groupby('shapeGroup')['pop_density'].transform(lambda x: x / x.sum())
